...
OBJECTFILES= \
	...
	${OBJECTDIR}/infix_evaluator_tests.o \
	${OBJECTDIR}/postfix_evaluator.o \
	${OBJECTDIR}/postfix_evaluator_tests.o \
	${OBJECTDIR}/token.o \
	${OBJECTDIR}/tokenizer.o \
	${OBJECTDIR}/tokenizer_tests.o
...
${OBJECTDIR}/infix_converter.o: infix_converter.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/infix_converter.o infix_converter.cpp

${OBJECTDIR}/infix_evaluator.o: infix_evaluator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/infix_evaluator.o infix_evaluator.cpp

${OBJECTDIR}/infix_evaluator_tests.o: infix_evaluator_tests.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/infix_evaluator_tests.o infix_evaluator_tests.cpp

${OBJECTDIR}/postfix_evaluator.o: postfix_evaluator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/postfix_evaluator.o postfix_evaluator.cpp

${OBJECTDIR}/postfix_evaluator_tests.o: postfix_evaluator_tests.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/postfix_evaluator_tests.o postfix_evaluator_tests.cpp
...
${OBJECTDIR}/tokenizer_tests.o: tokenizer_tests.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tokenizer_tests.o tokenizer_tests.cpp
